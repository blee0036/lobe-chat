...
const Qwen: ModelProviderCard = {
  chatModels: [
    ...
    },
    {
      contextWindowTokens: 1_000_000,
      description:
        'Qwen3.6 Flash is a fast multimodal Qwen model for text, image and video inputs.',
    ...
    {
      contextWindowTokens: 1_000_000,
      description: 'Qwen3.6 Plus is a high-capability multimodal model with 1M context.',
