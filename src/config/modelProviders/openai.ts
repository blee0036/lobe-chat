...
const OpenAI: ModelProviderCard = {
  ...
  chatModels: [
    ...
    },
    {
      contextWindowTokens: 1_048_576,
      description:
        'DeepSeek V4 Flash 是 DeepSeek V4 系列的高速低成本模型，适合大规模通用文本任务。',
    ...
    },
    {
      contextWindowTokens: 1_000_000,
      description:
        'Claude Opus 4.8 Fast Extended thinking 是 Claude Opus 4.8 Fast 的扩展思考版本。',
    ...
    },
    {
      contextWindowTokens: 1_000_000,
      description:
        'Claude Opus 4.7 Fast Extended thinking 是 Claude Opus 4.7 Fast 的扩展思考版本。',
    ...
    },
    {
      ...
      description:
        'Nano Banana Pro 是 Google 高能力原生多模态图像模型，支持通过对话生成和编辑图像。',
    ...
    },
    {
      contextWindowTokens: 1_048_576,
      description:
        'MiniMax M3 is a native multimodal agent model with text, image and video inputs.',
