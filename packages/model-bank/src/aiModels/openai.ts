...
export const openaiChatModels: AIChatModelCard[] = [
  ...
  },
  {
    ...
    contextWindowTokens: 400_000,
    description:
      'ChatGPT 中使用的 GPT-5.1 模型。结合了强大的语言理解与生成能力，适合对话式交互应用。',
  ...
  // 官转claude
  {
    ...
    displayName: '官Claude Sonnet 4.6',
    enabled: true,
    id: 'claude-sonnet-4-6-guan',
    maxOutput: 64_000,
    pricing: {
      units: [
        { name: 'textInput', rate: 5, strategy: 'fixed', unit: 'millionTokens' },
  ...
  },
  {
    ...
    displayName: '官Claude Sonnet 4.6 Extended thinking',
    enabled: true,
    id: 'claude-sonnet-4-6-guan-thinking',
    maxOutput: 64_000,
    pricing: {
      units: [
        { name: 'textInput', rate: 5, strategy: 'fixed', unit: 'millionTokens' },
  ...
  },
  {
    ...
    displayName: '官Claude Opus 4.6',
    enabled: true,
    id: 'claude-opus-4-6-guan',
    maxOutput: 64_000,
    pricing: {
      units: [
        { name: 'textInput', rate: 5, strategy: 'fixed', unit: 'millionTokens' },
  ...
  },
  {
    ...
    displayName: '官Claude Opus 4.6 Extended thinking',
    enabled: true,
    id: 'claude-opus-4-6-guan-thinking',
    maxOutput: 64_000,
    pricing: {
      units: [
        { name: 'textInput', rate: 5, strategy: 'fixed', unit: 'millionTokens' },
  ...
  },
  {
    ...
    contextWindowTokens: 200_000,
    description: 'Claude Sonnet 4.5 Extended thinking 是 Anthropic 迄今为止最智能的模型。',
  ...
  },
  {
    ...
    contextWindowTokens: 200_000,
    description:
      'Claude 3.7 Sonnet Extended thinking 是 Anthropic 迄今为止最智能的模型，也是市场上首个混合推理模型。Claude 3.7 Sonnet 可以产生近乎即时的响应或延长的逐步思考，用户可以清晰地看到这些过程。Sonnet 特别擅长编程、数据科学、视觉处理、代理任务。',
  ...
  },
  {
    ...
    pricing: {
      units: [
        ...
        { name: 'imageInput', rate: 0.9, strategy: 'fixed', unit: 'millionTokens' },
        { name: 'textOutput', rate: 7.5, strategy: 'fixed', unit: 'millionTokens' },
        { name: 'imageOutput', rate: 90, strategy: 'fixed', unit: 'millionTokens' },
      ],
    },
